#ifndef DSCAN_GRAPH_H_
#define DSCAN_GRAPH_H_
...
private:
    // computation stages
    void DSCANFirstPhasePrune();

    void DSCANSecondPhaseCheckCore();

    void DSCANThirdPhaseClusterCore();

    void MarkClusterMinEleAsId();

    void DSCANFourthPhaseClusterNonCore();
